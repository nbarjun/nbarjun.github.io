---
title: 'Mapping the Future: How to Explore Climate Change with CMIP6 Data'
date: 2012-08-14
...
A detailed list of the libraries I used and their versions can be found [here]. The easiest and cleanest way to install these packages is by using Anaconda environments. This helps you avoid dependency conflicts and manage your setup more efficiently. To get started with Conda environments, follow this [official tutorial](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html). 
